...
$row = '<table><tr><td>Lote</td><td>Tipo</td><td>Cantidad de Muestra</td><td>Impureza</td><td>Número de Pesa</td><td>Estado</td></tr>';

foreach($resultado as $res) {
  $row = $row . '<tr>' . '<td>'. $res->lote . '</td><td>' . $res->materia . '</td><td>' . $res->cantidad . '</td><td>' . $res->impureza . '</td><td>' . $res->pesa.'</td><td>' . $res->estado  . '</td></tr>';
}
