    ...
    <div class="form__container">
      <form class="form__content" action="<?php echo __URL__ . '/materias_primas_analisis/insert'; ?>" method="POST">
        ...
        <div class="form__controls">
          ...
          <input class="form__control" name="lote" type="text" value="0" placeholder="00000000-0"/> 
        </div>
        ...
        <div class="form__controls">
          ...
          <input class="form__control" name="cantidad_muestra" type="text" value="" placeholder="00000000-0"/> 
        </div>

        <div class="form__controls">
          <label class="form__label" for="">% Humedad</label>
          <input class="form__control" name="humedad" type="text" value="" placeholder="00000000-0"/> 
        </div>

        <div class="form__controls">
          <label class="form__label" for="">% Impureza</label>
          <input class="form__control" name="impureza" type="text" value="" placeholder="00000000-0"/> 
        </div>

        <div class="form__controls">
          <label class="form__label" for="">Número Pesa</label>
          <input class="form__control" name="numero_pesa" type="text" value="" placeholder="00000000-0"/> 
        </div>

        <div class="form__controls">
          <label class="form__label" for="">Tamiz 1</label>
          <input class="form__control" name="tamiz_1" type="text" value="" placeholder="00000000-0"/> 
        </div>

        <div class="form__controls">
          <label class="form__label" for="">Tamiz 2</label>
          <input class="form__control" name="tamiz_2" type="text" value="" placeholder="00000000-0"/> 
        </div>

        <div class="form__controls">
          <label class="form__label" for="">Tamiz 3</label>
          <input class="form__control" name="tamiz_3" type="text" value="" placeholder="00000000-0"/> 
        </div>

        <div class="form__controls">
          <label class="form__label" for="">Tamiz 4</label>
          <input class="form__control" name="tamiz_4" type="text" value="" placeholder="00000000-0"/> 
        </div>
