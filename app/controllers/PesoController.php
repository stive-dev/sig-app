...
INNER JOIN motorista ON control.dui_motorista=motorista.dui;");
    ...
    require_once __ROOT_PATH__ . "/app/views/peso/index.php";
  }
  ...
  public function add() {
    ...
    require_once __ROOT_PATH__ . "/app/views/peso/add.php";
  }
  ...
  public function modify() {
    ...
    require_once __ROOT_PATH__ . "/app/views/peso/modify.php";
  }
